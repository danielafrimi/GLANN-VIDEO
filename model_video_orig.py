...
class _background(nn.Module):
    def __init__(self, nz):
        ...
        self.bn_conv3_background = nn.BatchNorm2d(256)
        self.bn_conv4_background = nn.BatchNorm2d(128)
        self.bn_conv5_background = nn.BatchNorm2d(64)
        self.non_lin_background = nn.ReLU()
        self.tanh_background = nn.Tanh()
        self.conv2_background = nn.ConvTranspose2d(512, 256, 4, 2,1,  bias=True)
        self.conv3_background = nn.ConvTranspose2d(256, 128, 4, 2, 1, bias=True)
        self.conv4_background = nn.ConvTranspose2d(128, 64, 4, 2, 1, bias=True)
        self.conv5_background = nn.ConvTranspose2d(64, 3, 4, 2, 1, bias=True)
...
class G_video(nn.Module):
    def __init__(self, nz):
        ...
        self.conv3 = nn.ConvTranspose3d(256, 128, 4, 2, 1, bias=True)
